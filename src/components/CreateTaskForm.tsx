...
export const CreateTaskForm: React.FC = () => {  //FC = Functional Component
  ...
  return (
    <Dialog.Root>
      {/* Botão gatilho que ativa a tela para cadastrar uma tarefa */}
      <Dialog.Trigger>
      <Button>
      ...
      {/* Tela do formulário para criar a tarefa */}
      <Dialog.Content maxWidth="32rem">
        ...
        <Flex direction="column" gap="4">
          ...
          <Flex gap={"8"}>
            {/* Criação do seletor Rádio para situação da tarefa */}
            <Box>
            ...
            {/* Criação do seletor para a Prioridade da tarefa */}
            <Box>
          ...
          <Flex gap="2" justify="end">
            <Dialog.Close>
              {/* Botão de cancelar estilizado com um cinza na variante suave */}
